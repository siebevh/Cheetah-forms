        ...
        <v-layout row wrap>
          <template v-for="field in schema.fields">
            <v-flex :[dynamicFlex(field)]="true">
              <form-group :extra-options="extraOptions" :field="field" :model="model" @model-updated="onModelUpdated"></form-group>
            </v-flex>
          </template>
        </v-layout>
      </v-form>
                ...
                <v-layout row wrap>
                  ...
                  <template v-for="field in group.fields">
                    <v-flex :[dynamicFlex(field)]="true">
                      ...
                      <form-group :extra-options="extraOptions" :field="field" :model="model"
